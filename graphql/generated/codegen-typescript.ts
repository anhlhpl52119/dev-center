...
export const GetPageByPathDocument = gql`
  ...
  pages {
    ...
    `;
export const LeftNavigationBarTreeDocument = gql`
    query LeftNavigationBarTree($path: String, $mode: PageTreeMode!, $locale: String!) {
  pages {
    ...
    `;
export const SearchByTagsDocument = gql`
    query SearchByTags($tags: [String!]!) {
  pages {
    menu(tags: $tags) {
      id
      path
    ...
    `;
export const SearchPagesByKeywordDocument = gql`
    query SearchPagesByKeyword($query: String!, $category: String, $locale: String, $page: Int, $size: Int, $inCategory: [String]) {
  pages {
    search(
      query: $query
      category: $category
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    GetPageByPath(variables: GetPageByPathQueryVariables, options?: C): Promise<GetPageByPathQuery> {
      return requester<GetPageByPathQuery, GetPageByPathQueryVariables>(GetPageByPathDocument, variables, options) as Promise<GetPageByPathQuery>;
    },
    LeftNavigationBarTree(variables: LeftNavigationBarTreeQueryVariables, options?: C): Promise<LeftNavigationBarTreeQuery> {
      return requester<LeftNavigationBarTreeQuery, LeftNavigationBarTreeQueryVariables>(LeftNavigationBarTreeDocument, variables, options) as Promise<LeftNavigationBarTreeQuery>;
    },
    SearchByTags(variables: SearchByTagsQueryVariables, options?: C): Promise<SearchByTagsQuery> {
      return requester<SearchByTagsQuery, SearchByTagsQueryVariables>(SearchByTagsDocument, variables, options) as Promise<SearchByTagsQuery>;
    },
