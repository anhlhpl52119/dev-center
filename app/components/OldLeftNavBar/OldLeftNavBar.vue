...
<template>
  <nav class="sdc-lnb js-lnb d-flex d-md-block align-items-center" :class="{ collapsed: isCollapseWidthLNBDesktop }">
    <div
      v-show="isShowBtnToggleLNB"
      class="sdc-lnb-toggle-wrapper flex-grow-1"
      @click="showSidebar"
    >
      <i
